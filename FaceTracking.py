...
def findFace(img):
    faceCascade = cv2.CascadeClassifier("C:\\Users\li_yu\AppData\Local\Programs\Python\Python39\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
    faceCascade.load("C:\\Users\li_yu\AppData\Local\Programs\Python\Python39\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
